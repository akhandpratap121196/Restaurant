...
<div class="menu-container">
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>Hamburger: <span>Rs.49</span></h4>
      <p>
  ...
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>Cheeseburger: <span>Rs.99</span></h4>
  ...
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>Double Cheeseburger: <span>Rs.69</span></h4>
  ...
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>BBQ Ribs: <span>Rs.89</span></h4>
  ...
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>Grilled Cheese Sandwich: <span>Rs.59</span></h4>
      <p>
  ...
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>Caesar Salad: <span>Rs.79</span></h4>
      <p>
  ...
  <div class="menu-item">
    ...
    <div class="item-content">
      <h4>French Fries: <span>Rs.99</span></h4>
      <p>
